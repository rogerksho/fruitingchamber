...
class SHT31(object):
    ...
    def get_temp_humi_bytes(self, r=R_HIGH, cs=False):
    ...
    def _raw_temp_humi(self, r=R_HIGH, cs=False):
        """
    ...
    def get_temp_humi(self, resolution=R_HIGH, clock_stretch=False, celsius=True):
        """
...
def decode_raw_temp_humi(raw):
    th_decimal = (raw[0] << 8) + raw[1], (raw[3] << 8) + raw[4]
    return (-45 + (175 * (th_decimal[0] / 65535)), 100 * (th_decimal[1] / 65535))